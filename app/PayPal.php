...
class PayPal
{
    ...
    {
        return route('paypal.checkout.cancelled', $order->user_id);
    }
    ...
    {
        return route('paypal.checkout.completed', $order->user_id);
    }
    ...
    public function getNotifyUrl($order)
    {
        ...
        return route('webhook.paypal.ipn', [$order->user_id, $env]);
    }
}